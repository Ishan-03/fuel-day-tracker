      ...
      <div className="max-w-6xl mx-auto px-4 py-10 grid gap-8 md:grid-cols-1">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
            Track your fuel days easily using the odd/even vehicle number
            system. Stay updated and never miss your fuel schedule.
          </p>
        </div>

        {/* Copyright */}
        <div className="text-sm text-gray-600 dark:text-gray-400 pt-4 border-t border-gray-200 dark:border-gray-800">
          © {new Date().getFullYear()} Fuel Days Tracker by CFE404. All rights
          reserved.
        </div>
      </div>
    </footer>
